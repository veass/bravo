...
/**
 * Сервис рассчитывающий переводчиков по правилу дэдлайн днем выбираем переводчиков по будним дня и тех кто работает по любым, дэдлайн попадающий на выходные будет распределятся на переводчиков работающие в любые дни.
 */
